...
public class TagsRecyclerView extends RecyclerView {
    ...
    public TagsRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public TagsRecyclerView(Context context, AttributeSet attrs, int defStyle) {
